describe('blego.tools.copy', () => {
  ...
  it('Throws if source does not exist', () => {
    ...
    expect(pathDoesNotExistSpy).toHaveBeenCalledWith('/fake/directory1/file0');
  });
  ...
  it('Throws if destination file already exists', () => {
    ...
    expect(pathExistsSpy).toHaveBeenCalledWith('/fake/directory1/file2');
  });
  ...
  it('Throws if destination directory already contains a source file', () => {
    ...
    expect(pathExistsSpy).toHaveBeenCalledWith('/fake/directory4/file1');
  });
